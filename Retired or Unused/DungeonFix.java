...
public class DungeonFix extends JPanel implements Runnable
{
    ...
    public DungeonFix() throws InstantiationException, IllegalAccessException
    {
        window = new JFrame("Hazardous Laboratory");
        dungeon = new DungeonBuilder(1,1,1,100,100,1,null, null);
        tileArray = DungeonBuilder.tileList;
    }
...
//Calling game.repaint() will update what's in here.
   ...
   {
       //Testing
       DungeonFix game = new DungeonFix();
       game.dungeonLoop();
   }
}